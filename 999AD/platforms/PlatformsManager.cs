        ...
        public static void Inizialize(Texture2D _spritesheet)
        {
            ...
            platformsRoomManagers = new PlatformsRoomManager[(int)RoomsManager.Rooms.total]
            {
                ...
                (
                    new MovingPlatform[]
                    {
                        new MovingPlatform(MovingPlatform.TextureType.dirt40_8, 205, FinalBoss.fireballsCenter, Vector2.Zero, 0.5f,0,false,0),
                        new MovingPlatform(MovingPlatform.TextureType.dirt40_8, 205, FinalBoss.fireballsCenter, Vector2.Zero, 0.5f,0,false,120),
                        new MovingPlatform(MovingPlatform.TextureType.dirt40_8, 205, FinalBoss.fireballsCenter,Vector2.Zero, 0.5f,0,false,240),
                        new MovingPlatform(MovingPlatform.TextureType.dirt40_8, 160, FinalBoss.fireballsCenter,Vector2.Zero, -0.5f,0,false,180),
                        new MovingPlatform(MovingPlatform.TextureType.dirt40_8, 160, FinalBoss.fireballsCenter, Vector2.Zero,-0.5f,0,false,60),
                        new MovingPlatform(MovingPlatform.TextureType.dirt40_8, 160, FinalBoss.fireballsCenter,Vector2.Zero, -0.5f,0,false,300),
